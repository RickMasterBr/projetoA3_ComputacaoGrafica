...
class Engine:
    ...
    def run(self):
        ...
        while not glfw.window_should_close(self.window):
            ...
            # Aumentei o size para 150 para cobrir mais do mundo
            near_plane = 1.0
            far_plane = 300.0
            size = 150.0 
